...
// ErrorFull mocks base method.
func (m *MockLogger) ErrorFull(error error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ErrorFull", error)
}

// ErrorFull indicates an expected call of ErrorFull.
func (mr *MockLoggerMockRecorder) ErrorFull(error interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ErrorFull", reflect.TypeOf((*MockLogger)(nil).ErrorFull), error)
}
...
func (m *MockLogger) Tracef(s string, i ...interface{}) {
	m.ctrl.T.Helper()
	varargs := []interface{}{s}
	for _, a := range i {
		varargs = append(varargs, a)
...
func (mr *MockLoggerMockRecorder) Tracef(s interface{}, i ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{s}, i...)
